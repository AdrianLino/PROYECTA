          ...
          Row(
            children: [
              Expanded(
                  child: Container(
                height: 15,
                color: const Color.fromARGB(255, 12, 103, 179),
              )),
              Expanded(
                  child: Container(
                      height: 15, color: Color.fromARGB(255, 255, 200, 0))),
              Expanded(
                  child: Container(
                height: 15,
                color: Color.fromARGB(255, 38, 212, 32),
              )),
              Expanded(
                  child: Container(
                height: 15,
                color: const Color.fromARGB(255, 235, 34, 19),
              )),
            ],
          ),
